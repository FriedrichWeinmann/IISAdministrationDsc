...
Remove-Module IISAdministrationDsc -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\IISAdministrationDsc\IISAdministrationDsc.psd1"
Import-Module "$PSScriptRoot\..\IISAdministrationDsc\IISAdministrationDsc.psm1" -Force
