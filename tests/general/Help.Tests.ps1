...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\IISAdministrationDsc\functions", "$global:testroot\..\IISAdministrationDsc\internal\functions"),
	
	[string]
	$ModuleName = "IISAdministrationDsc",
...
$CommandPath = @(
    "$global:testroot\..\IISAdministrationDsc\functions"
    "$global:testroot\..\IISAdministrationDsc\internal\functions"
)
